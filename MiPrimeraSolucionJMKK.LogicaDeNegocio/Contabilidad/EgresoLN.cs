    ...
    public class RegistrarEgresoLN : IRegistrarEgresoLN
    {
        ...
        public bool Registrar(EgresoDto egreso)
        {
            try
            {
                ...
                if (egreso.Monto <= 0)
                    throw new ArgumentException("El monto ingresado no es valido. Debe ser un valor mayor a cero.");
                ...
                if (resultado > 0)
                {
                    _bitacora.Registrar(
                        "Registro de Egreso",
                        "Se registro un egreso de " + egreso.Monto.ToString("C2") + ": " + egreso.Descripcion,
