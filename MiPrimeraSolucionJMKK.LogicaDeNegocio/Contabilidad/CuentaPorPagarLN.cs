            ...
            try
            {
                ...
                if (resultado > 0)
                {
                    _bitacora.Registrar(
                        ...
                        "Se registro una cuenta por pagar a " + cuenta.Proveedor + " por " + cuenta.Monto.ToString("C2") +
        ...
        public bool MarcarComoPagada(int idCuentaPorPagar, string cedulaRegistro)
        {
            try
            {
                if (idCuentaPorPagar <= 0)
                    throw new ArgumentException("La cuenta por pagar indicada no es valida.");
                ...
                {
                    _bitacora.Registrar(
                        "Liquidacion de Cuenta por Pagar",
                        "Se liquido la cuenta por pagar #" + idCuentaPorPagar,
                        cedulaRegistro,
                        "Contabilidad");
